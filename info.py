...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "{<b>📂 Fɪʟᴇ ɴᴀᴍᴇ : </b> <code>{file_name}</code><b>/n/n 🔰 𝙹𝙾𝙸𝙽 𝙼𝙰𝙸𝙽 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 👇/n/n🍿ᴄʜʟ : @Movies_Tamizhaaas /n⚡ɢʀᴘ : @MT_Movies_Request
</b>")
